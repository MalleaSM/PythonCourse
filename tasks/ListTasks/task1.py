...
answer = []
answer = [(firstLetter  + secondLetter  + firstDigit + seconDigit) for firstLetter in lowercase  for secondLetter in lowercase  for firstDigit in digits for seconDigit in digits]
print(answer)
